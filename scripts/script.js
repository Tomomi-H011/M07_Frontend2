...
addEventListener('DOMContentLoaded', async function () {
    ...
    for (let song of songs) {
        let songID = song._id;
        html += `<li>${song.title} - ${song.artist} - ${song.username} - <a href="details.html?id=${songID}">Details</a> - <a href="edit.html?id=${songID}">Edit Song</a></li>`;  // Add the song title and artist to the html
    } 
